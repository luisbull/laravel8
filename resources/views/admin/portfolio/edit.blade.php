                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('portfolio.update', $portfolio->id) }}" method="POST"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="file" name="portfolio_image" multiple="" class="form-control"
                                            id="portfolioImage" aria-describedby="PortfolioImage">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" id="portfolioCategory" name="portfolio_category"
                                            ...
                                            {{-- <option value="{{$portfolio->cat_id}}" selected>{{$portfolio->cat_id}}</option> --}}
                                            @foreach ($categories as $category)
                                                @if ($category->id == $portfolio->cat_id)
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a href="{{ route('all.multiImage') }}"
                                            class="btn btn-secondary btn-default">Cancel</a>
                                    </div>
                                </form>
